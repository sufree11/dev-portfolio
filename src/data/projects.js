...
const projects = [
  ...
  },
  {
    ...
    year:        '05/2026',
    description: 'Collaborative group project, utilising a full PHP and Javascript backend with a CSS3 frontend, alongside stylisation through Tailwind CSS, to create an app platform for Imvidia Electronics, allowing users to browse products, add items to their cart or wishlist, make purchases, and review products.',
